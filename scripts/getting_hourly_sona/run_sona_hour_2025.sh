...
#SBATCH --output=/mnt/scratch/users/cw1781/btt_cal_processing/logs/sona_2025/sona_%a.out
#SBATCH --error=/mnt/scratch/users/cw1781/btt_cal_processing/logs/sona_2025/sona_%a.err

# Load R module if required
module load R/4.4.1-gfbf-2023b

# Run the R script, passing the array ID
Rscript hourly_sona_array_2025.R $SLURM_ARRAY_TASK_ID