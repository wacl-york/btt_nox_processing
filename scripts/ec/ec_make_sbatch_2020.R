...
dataPath = "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec/in/2020"
...
outputFile = "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/logs_2020/%x_%j_%a.log"
errFile = "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/logs_2020/%x_%j_%a.err"
...
data_file = file(paste0('/mnt/scratch/users/',user,'/btt_cal_processing/btt_nox_processing/sbatch/run_1_0_1_2020.sbatch'), open = "wt")
