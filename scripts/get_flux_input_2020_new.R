...
out_root <- "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_2/in"
cal_root  <- "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/1Hz_cal_data"
ERA5_root <- "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/modelled_data/pressure_corrected.csv"
