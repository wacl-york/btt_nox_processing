...
#SBATCH --output=/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/tidy_logs/sensitivity_tests/test4/%x_%j_%a.log       # Standard output log
#SBATCH --error=/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/tidy_logs/sensitivity_tests/test4/%x_%j_%a.err        # Standard error log
...
base_out <- "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec/out_bound/sensitivity_tests/test4"

outputs = tibble(
  filePath = system(
    paste("find", "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec/out/sensitivity_tests/test4", "-type f"),
    intern = TRUE
  )
)|> 
  mutate(
