...
#SBATCH --output=/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/tidy_logs/2023/%x_%j_%a.log       # Standard output log
#SBATCH --error=/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/tidy_logs/2023/%x_%j_%a.err        # Standard error log
...
base_out <- "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec/out_bound/2023"

outputs = tibble(
  filePath = system(
    paste("find", "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec/out/BTT/standard_2023", "-type f"),
    intern = TRUE
  )
)|> 
  mutate(
