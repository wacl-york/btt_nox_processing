...
#SBATCH --output=/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/tidy_logs/2022/%x_%j_%a.log       # Standard output log
#SBATCH --error=/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec_logs/tidy_logs/2022/%x_%j_%a.err        # Standard error log
#SBATCH --array=0-96          # Array range
...
base_out <- "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec/out_bound/2022"

outputs = tibble(
  filePath = system(
    paste("find", "/mnt/scratch/projects/chem-cmde-2019/btt_processing/processing/ec/out/BTT/standard_2022", "-type f"),
    intern = TRUE
  )
)|> 
  mutate(
