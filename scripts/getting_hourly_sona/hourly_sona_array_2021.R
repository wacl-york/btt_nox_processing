...
# --- 1. GET THE FILE LIST ---
sona_files <- list.files("/mnt/scratch/projects/chem-cmde-2019/btt_processing/raw_data/sona_data/2021", 
...
temp_dir <- "/mnt/scratch/users/cw1781/btt_cal_processing/btt_nox_processing/data/data/temp_sona/2021"
